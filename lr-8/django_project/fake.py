...
cursor.executemany("INSERT INTO Premise (area, rent_cost, floor, phone_in_premise, decoration_type) VALUES (%s, %s, %s, %s, %s);", premises_data)
...
cursor.executemany("INSERT INTO RentalAgreement (start_date, duration_days, purpose, tenant_id, premise_id) VALUES (%s, %s, %s, %s, %s);", rental_data)
