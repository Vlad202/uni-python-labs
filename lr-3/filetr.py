...
if not os.path.exists(text_file):
    ...
    if num_chars < min_chars:
        print(f"Error: Текст занадто короткий. Мінімум потрібно 600 символів, а у файлі лише {num_chars}.")
    else:
        ...
        if num_chars > max_chars:
            print(f"Error: Текст перевищує ліміт символів. Максимум дозволено {max_chars}, а у файлі {num_chars}.")
        elif num_words > max_words:
            print(f"Error: Текст перевищує ліміт слів. Максимум дозволено {max_words}, а у файлі {num_words}.")
        elif num_sentences > max_sentences:
            print(f"Error: Текст перевищує ліміт речень. Максимум дозволено {max_sentences}, а у файлі {num_sentences}.")
        else:
